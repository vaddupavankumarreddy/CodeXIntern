    ...
    return (
        <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
            <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
                <a href="javascript:void(0)" className="max-sm:hidden"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0c6a8m-Dr93Lf1zVkHq6zZoHdLun4eNO1pw&s" alt="logo" className='w-10' /></a>
                <a href="javascript:void(0)" className="hidden max-sm:block"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0c6a8m-Dr93Lf1zVkHq6zZoHdLun4eNO1pw&s" alt="logo" className='w-9' /></a>
                ...
                <div id="collapseMenu"
                    ...
                    <ul
                        ...
                        <li className='mb-6 hidden max-lg:block'>
                            <a href="javascript:void(0)"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0c6a8m-Dr93Lf1zVkHq6zZoHdLun4eNO1pw&s" alt="logo" className='w-36' />
                            </a>
                        </li>
